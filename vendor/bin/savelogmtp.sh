...
############################################################################################
	...
	cp -r /data/logcat_log/tcpdump* $SAVE_LOG_PATH/logcat_log
...
######################################################################################
	...
	cp /asdf/logcat-charger.txt $SAVE_LOG_PATH/charger_debug/
############################################################################################
...
if [ -d "/data/vendor/ramdump/diag_logs/" ]; then
    mkdir $SAVE_LOG_PATH/diag_logs
    ls -R -l /data/vendor/ramdump/diag_logs > $SAVE_LOG_PATH/diag_logs/ls_diag_logs.txt
    cp -r /data/vendor/ramdump/diag_logs/* $SAVE_LOG_PATH/diag_logs/
